...
public class RespaldoBd{
    ...
    public void crearBackup() throws IOException{ //puede llamarse crearRespaldo()
        ...
        Process proceso = Runtime.getRuntime().exec("C:\\xampp\\mysql\\bin\\mysqldump -u admin -p1234 cardiologybd"); //aqui pones tu ruta de Mysql , usuario y password
        InputStream entrada = proceso.getInputStream();
        FileOutputStream archivo = new FileOutputStream("C:\\Cyberia\\RespaldosBD\\RespaldoBD-Cyberia" + fth.format(fechaactual) + ".sql");;
