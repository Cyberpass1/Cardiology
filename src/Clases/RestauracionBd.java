...
public void crearRestauracion() throws IOException{ 
    ...
    try{
        JFileChooser filechooser = new JFileChooser("C:\\Cyberia\\RespaldosBD");
        ...
        if (resultado == JFileChooser.APPROVE_OPTION){
            ...
            Process proceso = Runtime.getRuntime().exec("C:\\xampp\\mysql\\bin\\mysql -u admin -p1234 cardiologybd");
