   ...
   ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        JTableUsuarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nombre", "Apellido", "Cédula", "Telefono", "Correo", "Dirección", "Fec_Nacimiento"
            }
        ));
...
AuditoriaReporte();
   ...
   ResultSet rs=null;
    ...
    private void TXTBUSCARKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TXTBUSCARKeyReleased
     ...
     if(JRCED.isSelected()){            SearchbyCed();        if(JTableUsuarios.getRowCount()>0){  acomodarceldas(); }}
     else if(JRNOMBRE.isSelected()){    SearchbyNombre();     if(JTableUsuarios.getRowCount()>0){  acomodarceldas(); }}
     else if(JRCODIGO.isSelected()){    SearchbyCodigo();     if(JTableUsuarios.getRowCount()>0){  acomodarceldas(); }}
 ...
 String sql = "select IdPersonal, Nombre, Apellido, Cedula, Telefono, Correo, Direccion, date_format(Nacimiento, '%d/%m/%Y') AS Fecha  from table_personal where Cedula LIKE '%" + Busqueda + "%' ";
...
//DECLARACIÓN DEL MODELO DE LA TABLA
     ...
     String Busqueda = this.TXTBUSCAR.getText();
     String sql = "select IdPersonal, Nombre, Apellido, Cedula, Telefono, Correo, Direccion, date_format(Nacimiento, '%d/%m/%Y') AS Fecha  from table_personal where Nombre LIKE '%" + Busqueda + "%' ";
    ...
    String Busqueda = this.TXTBUSCAR.getText();
    String sql = "select IdPersonal, Nombre, Apellido, Cedula, Telefono, Correo, Direccion, date_format(Nacimiento, '%d/%m/%Y') AS Fecha  from table_personal where IdPersonal LIKE '%" + Busqueda + "%' ";
       ...
       public void acomodarceldas()
    {
        ...
        JTableUsuarios.getColumnModel().getColumn(Tabla.findColumn("Fec_Nacimiento")).setPreferredWidth(30);
        ...
        JTableUsuarios.getColumnModel().getColumn(Tabla.findColumn("Fec_Nacimiento")).setCellRenderer(Alinear);
