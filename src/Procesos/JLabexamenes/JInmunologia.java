   ...
   ResultSet rs=null;
    ...
    private void jButton34ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton34ActionPerformed
           ...
           if (TXTPapellido.getText().equals("") 
                   ...
                   || TXTANA.getText().equals("")
                   || TXTLUPICO.getText().equals("")
                   || TXTFIGM.getText().equals("")
                   || TXTFIGG.getText().equals("")
                   || TXTCIGM.getText().equals("")
                   || TXTC4.getText().equals("")
                   || TXTC3.getText().equals("")
                   || TXTIGG.getText().equals("")
