...
public class JSerologia extends javax.swing.JInternalFrame {
   ...
   ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jPanel7.add(jButton34, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 520, 200, 30));
        ...
        jPanel7.add(jButton20, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 520, 200, 30));
        jPanel7.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 500, 610, 20));

        TXTVDRL.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Nombre"), "V.D.R.L"));
        TXTVDRL.setOpaque(false);
        ...
        jPanel7.add(TXTVDRL, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 40, 300, 50));
        ...
        jPanel7.add(TXTrematoideo, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 160, 300, 50));

        TXTASTRO.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Nombre"), "Asto (Titulo Antiestreptolisisna)"));
        TXTASTRO.setOpaque(false);
        ...
        jPanel7.add(TXTASTRO, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 280, 300, 50));
        ...
        jPanel7.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, 430, 110));
        ...
        jPanel7.add(TXTREACTIVA, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 220, 300, 50));

        JCPruebasangre.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "NEGATIVA", "POSITIVA" }));
        ...
        JCPruebasangre.setOpaque(false);
        jPanel7.add(JCPruebasangre, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 100, 300, 50));
   ...
   char car = evt.getKeyChar();
    ...
    private void TXTVDRLKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TXTVDRLKeyTyped
        va.longitud(TXTVDRL.getText(), 30, evt);
...
private static int calcularEdad(Calendar fechaNac) {
   ...
   if (diferenciames < 0 || (diferenciames == 0 && diferenciadia < 0)) {
       ...
       //BODY 
           ...
           Tabla2.addCell(new Paragraph(TXTVDRL.getText().toString(),FontFactory.getFont("Arial",9,Font.NORMAL)));
 
                    
                
           Tabla2.addCell(new Paragraph("Prueba de Embarazo en la Sangre",FontFactory.getFont("Arial",9,Font.NORMAL))); 
           ...
           Tabla2.addCell(new Paragraph("Asto (Titulo Antiestreptolisisna)",FontFactory.getFont("Arial",9,Font.NORMAL))); 
           Tabla2.addCell(new Paragraph(TXTASTRO.getText(),FontFactory.getFont("Arial",9,Font.NORMAL)));
