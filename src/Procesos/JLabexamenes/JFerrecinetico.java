...
public class JFerrecinetico extends javax.swing.JInternalFrame {
   ...
   ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jPanel25.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 500, 590, 10));
        ...
        jPanel25.add(JCFERRITINA, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 510, -1, -1));

        JCLDH.setBackground(new java.awt.Color(255, 255, 255));
        JCLDH.setText("LDH");
        jPanel25.add(JCLDH, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 510, -1, -1));
    ...
    private void jButton34ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton34ActionPerformed
            ...
            JOptionPane.showMessageDialog(null, "ASIGNE UN PACIENTE, Y VERIFIQUE QUE TODOS LOS CAMPOS SE ENCUENTRAN COMPLETADOS", "LLENADO DE CAMPOS", JOptionPane.INFORMATION_MESSAGE);
                 ...
                 else   if ( JCFERRITINA.isSelected()==true && JCLDH.isSelected()==true)
                 {
                   
                   
                  if (TXTPapellido.getText().equals("") 
                   || TxtFerritina.getText().equals("")
                   || TXTLDH.getText().equals("")
                          
                   || TxtMujeres.getText().equals("")
                   || TxtHombres.getText().equals("")
                   || TxtRn.getText().equals("")
                   || Txtniños.getText().equals("")     
                   || TXTLDH1.getText().equals("")
