...
public class EstudioPersonalizado extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel9.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 520, 380, 50));
        ...
        JPregistro.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 220, 330, 120));
        ...
        JPregistro.add(FechaNacimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 180, 170, 30));
        ...
        JPregistro.add(jLabel111, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 130, 60));
        ...
        jPanel1.add(JPregistro, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 140, 380, 350));
        ...
        jPanel1.add(IdPacientess, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 70, 20, 50));
        ...
        jPanel9.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 380, 540));
        ...
        jPanel6.add(jButton34, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 510, 150, 30));
        ...
        jPanel6.add(jButton20, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 510, 150, 30));
        ...
        TxtRef0.setOpaque(false);
        Estudio3.add(TxtRef0, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 100, 90, 50));

        TxtUnd0.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Nombre"), "Unidad"));
        TxtUnd0.setOpaque(false);
        ...
        TXTNOMBRESTUDIO0.setOpaque(false);
        ...
        jPanel6.add(Estudio3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 320, 620, 160));
        ...
        TxtRef1.setOpaque(false);
        Estudio2.add(TxtRef1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 100, 90, 50));

        TxtUnidad1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Nombre"), "Unidad"));
        TxtUnidad1.setOpaque(false);
        ...
        TXTNOMBRESTUDIO1.setOpaque(false);
        ...
        TxtReferencia2.setOpaque(false);
        Estudio1.add(TxtReferencia2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 100, 90, 50));

        TxtUnidad2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Nombre"), "Unidad"));
        TxtUnidad2.setOpaque(false);
        ...
        TXTNOMBRESTDIO2.setOpaque(false);
        ...
        jPanel9.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 20, 620, 550));
    ...
    private void jButton34ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton34ActionPerformed
            ...
            JOptionPane.showMessageDialog(null, "ASIGNE UN PACIENTE, Y VERIFIQUE QUE TODOS LOS CAMPOS SE ENCUENTRAN COMPLETADOS", "LLENADO DE CAMPOS", JOptionPane.INFORMATION_MESSAGE);
             ...
             if (JOptionPane.showConfirmDialog(rootPane, "¿Está seguro que desea imprimir?",
            "Imprimir", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION)  {
                  
                  
                  JOptionPane.showMessageDialog(null, "GENERANDO REPORTE...","ESTUDIO",1);   MaxIdestudios();  pdf();  guardarReporte(); CancelarTodo();}
        }
...
cantidad3=cantidad3-1;
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
           ...
           if (TXTPapellido.getText().equals("") || TXTPnombre.getText().equals("") || FechaNacimiento.getDate()==null
            ...
            JOptionPane.showMessageDialog(null, "ASIGNE A UN PACIENTE Y COMPLETE TODOS LOS CAMPOS", "LLENADO DE CAMPOS", JOptionPane.INFORMATION_MESSAGE); } 
   ...
   if (diferenciames < 0 || (diferenciames == 0 && diferenciadia < 0)) {
       ...
       //BODY 
           ...
           // Tabla0.addCell("Masculino");
            ...
            Tabla1.addCell(new Paragraph("----- "+ TXTNOMBRESTDIO2.getText() +" ----- ",FontFactory.getFont("Arial",11,Font.BOLD))); 
            ...
            Paragraph t3columna1 = new Paragraph("");
            t3columna1.getFont().setStyle(Font.BOLD);
            t3columna1.getFont().setSize(10);        
            t3columna1.setFont(Letra);
            t3columna1.setAlignment(Element.ALIGN_CENTER);
            Tabla3.addCell(t3columna1);
            Tabla3.addCell(new Paragraph("----- "+ TXTNOMBRESTUDIO1.getText() +" ----- ",FontFactory.getFont("Arial",11,Font.BOLD))); 
            ...
            t5columna1.setAlignment(Element.ALIGN_CENTER);
            Tabla5.addCell(t5columna1);
            Tabla5.addCell(new Paragraph("----- "+ TXTNOMBRESTUDIO0.getText() +" ----- ",FontFactory.getFont("Arial",11,Font.BOLD))); 
