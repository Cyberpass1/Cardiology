  ...
  String  empresa, rif, ubicacion, telefonos, piepagina;
   ...
   ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jPanel7.add(jButton34, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 480, 200, 30));
        ...
        jPanel7.add(jButton20, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 520, 200, 30));
        jPanel7.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 460, 610, 20));
        ...
        jPanel7.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, 540, 110));

        TxtNota.setColumns(20);
        TxtNota.setFont(new java.awt.Font("Monospaced", 0, 10)); // NOI18N
        TxtNota.setRows(5);
        TxtNota.setText("ESTA PRUEBA TIENE UNA SENSIBILIDAD DE APROXIMADAMENTE 99% LO QUE QUIERE  DECIR \nQUE DE CADA 100 PACIENTES, 1 SERA FALSO NEGATIVO. SI USTED SOSPECHA DE PADECER\nSI USTED SOSPECHA DE PADECER EL  VIRUS  Y  OBTUVO  UN  RESULTADO  NEGATIVO, SE \nRECOMIENDA REPETIR LA PRUEBA LUEGO  DE  MINIMO  UNA  SEMANA  O  EN SU  DEFECTO \nREALIZAR UNA PRUEBA MAS ESPECIFICA COMO EL ELISA DE 4ta GENERACION O WESTER BLOT");
        ...
        jPanel7.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 540, 110));
        ...
        JCTest.setOpaque(false);
        jPanel7.add(JCTest, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 120, 260, 60));

        jPanel9.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 10, 610, 560));
...
private static int calcularEdad(Calendar fechaNac) {
   ...
   if (diferenciames < 0 || (diferenciames == 0 && diferenciadia < 0)) {
       ...
       //BODY 
           ...
           Tabla2.addCell(new Paragraph("Test de VIH (EDGENS)",FontFactory.getFont("Arial",9,Font.NORMAL))); 
