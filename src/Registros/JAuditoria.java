...
public class JAuditoria extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        FechaTwo.setDateFormatString("dd/MM/yyyy");
        ...
        FechaOne.setDateFormatString("dd/MM/yyyy");
        ...
        jPanel2.add(JRPERSONAL, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 20, -1, -1));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 1250, 110));
...
limpiarTablaEstudios();
    ...
    public ArrayList<Auditoria> ListarBetween_PdfVO() {
         ...
         String fecha = new SimpleDateFormat("dd/MM/yyyy").format(FechaOne.getDate());
...
"ON u.IdUsuario= p.IdPersonal WHERE FechaMov BETWEEN " + '"' + fecha + '"' + "AND"  + '"' + fecha2 + '"';
    ...
    public void acomodarceldas()
    {
        ...
        Jtabla.getColumnModel().getColumn(Tabla.findColumn("Accion")).setPreferredWidth(250);
...
"ON u.IdUsuario= p.IdPersonal WHERE FechaMov BETWEEN " + '"' + fecha + '"' + "AND"  + '"' + fecha2 + '"';
    ...
    try {
        ...
        footer.addCell(new Phrase(String.format("Emitido por:"+MP.JLabelNombre.getText()+"                                      |    www.fundaginebra.org    |                                            "+ writer.getPageNumber()+ " | Pág") , new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL, BaseColor.BLACK)));
...
"ON u.IdPersonal= w.IdPersonal\n" +
"INNER JOIN table_usuario p\n" +
"ON u.IdUsuario= p.IdPersonal  where Cedula LIKE '%" + jTextField1.getText() + "%' ";
        try {
...
"ON u.IdPersonal= w.IdPersonal\n" +
"INNER JOIN table_usuario p\n" +
"ON u.IdUsuario= p.IdPersonal  where Usuario LIKE '%" + jTextField1.getText() + "%' ";
        try {
